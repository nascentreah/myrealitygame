...
@section('content')
    ...
    <h5 style="color:teal">Your withdrawal will be successfully deposited to your bank account within 12 hours, this process will only be successful if you have referred upto two person's to make deposit on the platform</h5>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group mt-5">
                                    ...
                                    <span class="font-weight-bold pull-right">{{getAmount($withdraw->user->balance - ($withdraw->amount))}} {{$withdraw->cur_text }}</span>
                                </div>
                            </div>
                            <div class="col-md-8">
